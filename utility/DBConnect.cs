...
namespace Utilities
{
    ...
    {
        String SqlConnectString = "server=cis-mssql1.temple.edu;Database=sp19_3342_tuj18281;User id=tuj18281;Password=Aisa9umo";
        String SqlConnectStringOffCampus = "server=127.0.0.1,5555;Database=sp19_3342_tuj18281;User id=tuj18281;Password=Aisa9umo";
        ...
        public DBConnect()
        {
            ...
            if (!IsAvailable())
                myConnectionSql = new SqlConnection(SqlConnectStringOffCampus);
        }
